...
public class GpsDataBeanDao extends AbstractDao<GpsDataBean, Long> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_GPS_DATA_BEAN_DATA_TIME ON \"GPS_DATA_BEAN\"" +
                " (\"DATA_TIME\" ASC);");
        db.execSQL("CREATE INDEX " + constraint + "IDX_GPS_DATA_BEAN_SEND_FLAG ON \"GPS_DATA_BEAN\"" +
                " (\"SEND_FLAG\" ASC);");
    }
