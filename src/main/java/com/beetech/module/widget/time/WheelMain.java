package com.beetech.module.widget.time;

import android.view.View;
import com.beetech.module.R;
import com.beetech.module.utils.StringUtil;
...
public class WheelMain {
	...
	public String getTime() {
		...
		if (!hasSelectTime) {
			...
			sb.append(year).append("-").append(StringUtil.leftPad(month + "", 2, "0")).append("-").append(StringUtil.leftPad(day + "", 2, "0")).append(" ").append(StringUtil.leftPad(hour + "", 2, "0")).append(":").append(StringUtil.leftPad(min + "", 2, "0"));
		}
		return sb.toString();
	}
